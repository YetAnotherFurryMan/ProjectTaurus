...
dirs := $(BUILD)/obj $(BUILD)/bin $(BUILD)/lib $(BUILD)/test $(BUILD)/obj/toollib/ap $(BUILD)/obj/toollib/csv $(BUILD)/obj/toollib/vec $(BUILD)/obj/toollib/assoc $(BUILD)/obj/toollib/pgm $(BUILD)/obj/trs/error $(BUILD)/obj/trs/horn $(BUILD)/obj/trs/trs.cg.nasm_x86 $(BUILD)/obj/trs/trs.cg.lisp $(BUILD)/obj/trs/trsc
