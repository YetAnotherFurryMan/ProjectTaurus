...
dirs := $(BUILD)/obj $(BUILD)/bin $(BUILD)/lib $(BUILD)/test $(BUILD)/obj/ap $(BUILD)/obj/vec $(BUILD)/obj/assoc $(BUILD)/obj/pgm $(BUILD)/obj/error $(BUILD)/obj/horn $(BUILD)/obj/trs.cg.nasm_x86 $(BUILD)/obj/trs.cg.lisp $(BUILD)/obj/trsc
